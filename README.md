...
[![Build Status](https://travis-ci.org/ACME-Delivery-Service/web-api.svg?branch=master)](https://travis-ci.org/ACME-Delivery-Service/web-api)
...
6. If you did everything correct, https://acme-delivery-service.github.io/web-api/ will lead to your new docs
...
- Preview spec version for branch `[branch]`: https://acme-delivery-service.github.io/web-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://acme-delivery-service.github.io/web-api/ with url from the message: `Server started <url>`
